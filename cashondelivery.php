		...
		<div class="container">
			...
			<div class="shopper-informations">
			 ...
			 <div class="shopper-informations">
				<div class="row">
					<div class="col-sm-2">
						<div class="shopper-info cashondelivery_other" style="background: #FE980F;border-radius: 1px; border:1px solid #DF8103;padding: 8px 0px 8px 10px;margin-top: 10px">
