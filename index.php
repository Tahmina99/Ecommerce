			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											...
											<a href="product-details.php" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>View Details</a>
										</div>
										<div class="product-overlay"  style="opacity:0.4">
								...
								<div class="choose">
									<ul class="nav nav-pills nav-justified">
										<li><a href="wishlist.php"><i class="fa fa-plus-square"></i>Add to wishlist</a></li>
										<li><a href="cartlist.php"><i class="fa fa-plus-square"></i>Add to cart</a></li>
									</ul>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								...
								<div class="choose">
									<ul class="nav nav-pills nav-justified">
										<li><a href="wishlist.php"><i class="fa fa-plus-square"></i>Add to wishlist</a></li>
										<li><a href="cartlistt.php"><i class="fa fa-plus-square"></i>Add to cart</a></li>
									</ul>
								</div>
							</div>
						</div>
						...
						<div class="features_items"><!--features_items-->
						<h2 class="title text-center">Latest Brand Items</h2>
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
					...
					<div class="category-tab"><!--category-tab-->
						<div class="col-sm-12">
						<h2 class="title text-center">Latest Sell in this month</h2>
									...
									<div class="product-image-wrapper">
										<div class="single-products">
											<div class="productinfo text-center">
												...
												<h2>$56</h2>
												<p>Easy Polo Black Edition</p>
												<a href="product-details.php" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>View Detailst</a>
											</div>
