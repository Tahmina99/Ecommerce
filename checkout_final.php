	...
	<section id="cart_items" style="padding-bottom:50px">
		<div class="container">
			...
			<div class="shopper-informations">
				...
				<div class="row">
					<div class="col-sm-6">
							<div class="shopper-info payment1" style="background: #0BB3F7;border-radius: 2px">
							<a href="cashondelivery.php" style="color: #fff;display: block;padding: 20px"><img src="images/payment5.png" width="50"height="50">
					...
					<div class="col-sm-5">	
						<div class="shopper-info payment2" style="background:#EF3F73;border-radius: 2px">
							<a href="" style="color: #fff;display: block;padding: 20px"><img src="images/payment1.png" width="50"height="50">
