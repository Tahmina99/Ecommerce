					...
					<div class="col-sm-5">
						<div class="shopper-info">
							...
							<form>
								...
								<input style="width:70px" type="submit" value="Submit" name="signup_submit" class="btn btn-primary">
							</form>
						...
						<div class="shopper-info">
							<p>Login to your account</p>
								<form>
									<input type="text" placeholder="Email *" required>
									<input type="password" placeholder="password *" required>
									<input style="width:70px" type="submit" name="login_submit" value="Submit" class="btn btn-primary">
								</form>	
						</div>
					</div>					
				</div>
						...
						<div class="shopper-info">
							<p>Delivery Address</p>
								<form method="post" action="checkout_final.php">
									...
									<br><br>
									<input style="width:70px" type="submit" name="delivery_address_submit" value="Submit"  class="btn btn-primary cart cart_wishlist">
								</form>
						</div>
					</div>					
				</div>
